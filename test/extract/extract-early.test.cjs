/**
 * Sprite extraction test — EARLY span (5s–60s).
 * Tests real extension extraction at the beginning of the video.
 *
 * Usage: npm run test:extract:early
 */
'use strict';
...
async function run() {
  ...
  try {
    ...
    console.log('Sprite extraction — EARLY span (5s–60s, real extension)\n');
    ...
    assert(
      ...
      `extraction ran but no sprites found in early span`
    );
