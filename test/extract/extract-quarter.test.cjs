/**
 * Sprite extraction test — QUARTER span (2min mark).
 * Tests real extension extraction in the early-game transition.
 *
 * Usage: npm run test:extract:quarter
 */
'use strict';
...
async function run() {
  ...
  try {
    ...
    console.log('Sprite extraction — QUARTER span (2min, real extension)\n');
    ...
    assert(
      ...
      `extraction ran but no sprites found at 2min mark`
    );
