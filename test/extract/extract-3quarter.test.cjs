/**
 * Sprite extraction test — THREE-QUARTER span (10min mark).
 * Tests real extension extraction in the mid-late game transition.
 *
 * Usage: npm run test:extract:3quarter
 */
'use strict';
...
async function run() {
  ...
  try {
    ...
    console.log(
      'Sprite extraction — THREE-QUARTER span (10min, real extension)\n'
    );
    ...
    assert(
      ...
      `extraction ran but no sprites found at 10min mark`
    );
