/**
 * Sprite extraction test — LATE span (15min mark).
 * Tests real extension extraction toward end of video.
 *
 * Usage: npm run test:extract:late
 */
'use strict';
...
async function run() {
  ...
  try {
    ...
    console.log('Sprite extraction — LATE span (15min, real extension)\n');
    ...
    assert(
      ...
      `extraction ran but no sprites found in late span`
    );
